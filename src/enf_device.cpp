...
#define ALL_PHYSICAL_DEVICE_FEATURES_ENUMS ENUM(wideLines) ENUM(samplerAnisotropy)
...
#undef ALL_PHYSICAL_DEVICE_FEATURES_ENUMS
  ...
  QueueFamilyIndices Device::findQueueFamilies(VkPhysicalDevice device) {
    ...
    for (const VkQueueFamilyProperties &queueFamily: queueFamilies) {
      ...
      vkGetPhysicalDeviceSurfaceSupportKHR(device, static_cast<u32>(i), surface_, &presentSupport);
