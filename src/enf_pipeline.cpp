...
namespace Enforcer {
  ...
  void Pipeline::CreateGraphicsPipeline(const std::string &vertFilepath, const std::string &fragFilepath,
    ...
    ASSERT_LOG(configInfo.renderPass != VK_NULL_HANDLE, "Cannot create graphics pipeline :: no renderPass provided");

    auto vertexCode{ReadFile(vertFilepath)};
    auto fragmentCode{ReadFile(fragFilepath)};

    LOG_INFO(Shader, "[Vertex:Fragment] => [{}:{}]", vertexCode.size(), fragmentCode.size());
  ...
  void Pipeline::DefaultPipelineConfigInfo(PipelineConfigInfo &configInfo) {
    ...
    configInfo.inputAssemblyInfo.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST; // (1,2,3),(4,5,6) // not confuse
                                                                                 // with triangle strip:
                                                                                 // (1,2,3),(3,4,5)
  ...
  void Pipeline::SkyboxPipelineConfigInfo(PipelineConfigInfo &configInfo) {
    ...
    LOG_INFO(Vulkan, "SkyboxPipelineConfigInfo returned");
  ...
  void Pipeline::ShadowMapPipelineConfigInfo(PipelineConfigInfo &configInfo) {
    ...
    LOG_INFO(Vulkan, "ShadowMapPipelineConfigInfo returned");
  ...
  void Pipeline::OceanPipelineConfigInfo(PipelineConfigInfo &configInfo) {
    ...
    LOG_INFO(Vulkan, "OceanPipelineConfigInfo returned");
  ...
  Pipeline::Pipeline(Device &device, const std::string &vertFilepath, const std::string &fragFilepath,
                     const PipelineConfigInfo &configInfo, const std::vector<u32> specializedValues) : device{device} {
    CreateGraphicsPipeline(vertFilepath, fragFilepath, configInfo, specializedValues);
  }
